...
class PortfolioFileUpdaterTest {
	...
	static void writeSampleFile(File file) throws IOException {
		...
		buf.append("\"Symbol\",\"Name\",\"Price\",\"Quantity\",\"Total\",\"Cost basis\",\"Gain\",\"% Gain\"\n" + 
				...
				"\"GOLD.BBGOLD\",\"Safe Gold Investment\",\"457.0593\",\"10.0000\",\"4570\",\"-21050.1335\",\"21050.1335\",\"0.0000\"\n" + 
				"\"MONEXO\",\"Unmapped Investment\",\"457.0593\",\"10.0000\",\"4570\",\"-21050.1335\",\"21050.1335\",\"0.0000\"\n" + 
				"\"5GTH.ICICIPRU\",\"Maximizer V\",\"19.0468\",\"100.0000\",\"1904.68\",\"1300000.0007\",\"-70401.0662\",\"-5.4155\"\n" + 
